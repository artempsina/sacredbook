<?php
namespace CDBBC\feedback;

class cp_feedback{

	private $plugin_url = CDBBC_URL;
	private $plugin_version = CDBBC_VERSION;
	private $plugin_name = 'Cryptocurrency Donation Box - Bitcoin & Crypto Donations';
	private $plugin_slug = 'CDBBC';
