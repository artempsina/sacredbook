...
if (!class_exists('cdbbcFeedbackNotice')) {
    class cdbbcFeedbackNotice {
        /**
         * The Constructor
         */
        public function __construct() {
            ...
            if(is_admin()){
                add_action( 'admin_notices',array($this,'cdbbc_admin_notice_for_reviews'));
                add_action( 'admin_print_scripts', array($this, 'cdbbc_load_script' ) );
                add_action( 'wp_ajax_cdbbc_dismiss_notice',array($this,'cdbbc_dismiss_review_notice' ) );
            }
        }
	 ...
	 * @return void
	 */
	public function cdbbc_load_script() {
		wp_register_script( 'cdbbc-feedback-notice-script', CDBBC_URL.'/assets/js/cdb-admin-feedback-notice.js', array( 'jquery' ),null, true );
        wp_enqueue_script( 'cdbbc-feedback-notice-script' );
        wp_register_style( 'cdbbc-feedback-notice-styles',CDBBC_URL.'/assets/css/cdb-admin-feedback-notice.css' );
        wp_enqueue_style( 'cdbbc-feedback-notice-styles' );
    }
    // ajax callback for review notice
    public function cdbbc_dismiss_review_notice(){
   ...
   // admin notice  
    ...
    public function cdbbc_admin_notice_for_reviews(){
        ...
        if( $alreadyRated=="yes") {
          ...
          if (isset($diff_days) && $diff_days>=3) {
                echo $this->cdbbc_create_notice_content();
                }
       }  

       // generated review notice HTML
       function cdbbc_create_notice_content(){
        ...
        <ul>
            ...
            <li class="already_rated"><a href="javascript:void(0);" class="already_rated_btn button cdbbc_dismiss_notice" title="%7$s">Not Intrested</a></li>
